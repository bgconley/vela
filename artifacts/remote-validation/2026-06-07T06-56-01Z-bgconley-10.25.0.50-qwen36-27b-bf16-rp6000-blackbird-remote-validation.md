...
- Started: `2026-06-07T06:56:01Z`
- Local commit: `bf29838` (`bf29838a7354ea6f0981526d55d944fee8f08223`)
...
- SSH command: `ssh bgconley@10.25.0.50 env VELA_REMOTE_TARGET=blackbird bash -s -- /home/bgconley/repos/lab-tui 2700 auto /tank/venvs/lab-tui qwen36-27b-bf16-rp6000-blackbird `
 ...
 * branch            main       -> FETCH_HEAD
   63522cd..bf29838  main       -> origin/main
Updating 63522cd..bf29838
Fast-forward
 .wolf/buglog.json                                  |  38 ++++++
 .wolf/memory.md                                    |   4 +
 ...-27b-bf16-rp6000-blackbird-remote-validation.md | 142 +++++++++++++++++++++
 configs/qwen36-27b-bf16-rp6000-blackbird.yaml      |   6 +-
 configs/qwen36-27b-fp8-kvfp8-rp6000-blackbird.yaml |   6 +-
 docs/configuration.md                              |   5 +-
 docs/deployments.md                                |   5 +-
 docs/docker-runtime.md                             |  14 ++
 src/vela/config/schema.py                          |   4 +
 src/vela/engine/composer.py                        |  11 +-
 src/vela/engine/process_manager.py                 |  14 +-
 tests/test_blackbird_config.py                     |   8 ++
 tests/test_deployment_composer.py                  |  16 ++-
 tests/test_process_manager.py                      |   9 ++
 tests/test_tui_smoke.py                            |  20 ++-
 15 files changed, 288 insertions(+), 14 deletions(-)
 create mode 100644 artifacts/remote-validation/2026-06-07T06-35-55Z-bgconley-10.25.0.50-qwen36-27b-bf16-rp6000-blackbird-remote-validation.md
...
Building wheels for collected packages: vela
  ...
  Stored in directory: /tmp/pip-ephem-wheel-cache-3omldynp/wheels/3e/99/96/55613bfa0cc7c533e6eb1028217acc00841afc206a5665afde
...
running pid=3139392 socket=/run/user/1000/vela/agent.sock
== Remote host ==
620-01
...
running pid=3145019 socket=/run/user/1000/vela/agent.sock
DAEMON_RESTART_LIVE_RUN_OK run_id=daemon-restart-905e61e677d049a383bdd12c353a3135 port=54733 url=http://127.0.0.1:54733 returncode=0
== Disconnect/reconnect stream resume ==
DISCONNECT_RECONNECT_RESUME_OK run_id=disconnect-reconnect-ff2784c3bfe04859ac49867b8c6124b3 first_seq=1 resume_inode=17956919 resume_offset=34 url=http://127.0.0.1:60105 returncode=0
cwd=/home/bgconley/repos/lab-tui
...
READY http://10.25.0.51:18002 models=qwen36-27b-bf16-rp6000 run_id=35ca79c6238d4c979e4dfc3615bf5887
VELA_SMOKE_RUN_ID	35ca79c6238d4c979e4dfc3615bf5887
BACKEND_EVIDENCE_OK config=qwen36-27b-bf16-rp6000-blackbird run_id=35ca79c6238d4c979e4dfc3615bf5887
```

## Result

- Completed: `2026-06-07T07:00:48Z`
- Exit status: `0`
