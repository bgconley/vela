...
- Started: `2026-06-07T07:01:42Z`
- Local commit: `b7c607c` (`b7c607c49233bf3266805d6eeb984bd964f23a69`)
...
- SSH command: `ssh bgconley@10.25.0.50 env VELA_REMOTE_TARGET=blackbird bash -s -- /home/bgconley/repos/lab-tui 2700 auto /tank/venvs/lab-tui qwen36-27b-fp8-kvfp8-rp6000-blackbird `
 ...
 * branch            main       -> FETCH_HEAD
   bf29838..b7c607c  main       -> origin/main
Updating bf29838..b7c607c
Fast-forward
 .wolf/memory.md                                    |   1 +
 ...-27b-bf16-rp6000-blackbird-remote-validation.md | 154 +++++++++++++++++++++
 2 files changed, 155 insertions(+)
 create mode 100644 artifacts/remote-validation/2026-06-07T06-56-01Z-bgconley-10.25.0.50-qwen36-27b-bf16-rp6000-blackbird-remote-validation.md
...
Building wheels for collected packages: vela
  ...
  Stored in directory: /tmp/pip-ephem-wheel-cache-h9arhfto/wheels/3e/99/96/55613bfa0cc7c533e6eb1028217acc00841afc206a5665afde
...
running pid=3149749 socket=/run/user/1000/vela/agent.sock
== Remote host ==
620-01
...
running pid=3155376 socket=/run/user/1000/vela/agent.sock
DAEMON_RESTART_LIVE_RUN_OK run_id=daemon-restart-998605ef71404b8c9fdeba12bd4a9586 port=60665 url=http://127.0.0.1:60665 returncode=0
== Disconnect/reconnect stream resume ==
DISCONNECT_RECONNECT_RESUME_OK run_id=disconnect-reconnect-45dc2e391a5c426986708cfe69771873 first_seq=1 resume_inode=17956919 resume_offset=34 url=http://127.0.0.1:44293 returncode=0
cwd=/home/bgconley/repos/lab-tui
...
READY http://10.25.0.51:18003 models=qwen36-27b-fp8-kvfp8-rp6000 run_id=04579bbd4cb4403e93108a1157fce142
VELA_SMOKE_RUN_ID	04579bbd4cb4403e93108a1157fce142
BACKEND_EVIDENCE_OK config=qwen36-27b-fp8-kvfp8-rp6000-blackbird run_id=04579bbd4cb4403e93108a1157fce142
```

## Result

- Completed: `2026-06-07T07:05:29Z`
- Exit status: `0`
