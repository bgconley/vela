...
- Started: `2026-06-07T07:49:52Z`
- Local commit: `e74cabb` (`e74cabbd20ff06737cc93397cdd54a3ad91b9bf8`)
...
- SSH command: `ssh -i /Users/brennanconley/vibecode/infx/ubuntu24_ed25519 -o BatchMode=yes -o StrictHostKeyChecking=accept-new bgconley@10.25.0.50 env VELA_REMOTE_TARGET=blackbird bash -s -- /home/bgconley/repos/lab-tui 2700 auto /tank/venvs/lab-tui qwen36-27b-fp8-kvfp8-rp6000-blackbird `
...
Building wheels for collected packages: vela
  ...
  Stored in directory: /tmp/pip-ephem-wheel-cache-fagb7nho/wheels/3e/99/96/55613bfa0cc7c533e6eb1028217acc00841afc206a5665afde
...
running pid=3223980 socket=/run/user/1000/vela/agent.sock
== Remote host ==
620-01
...
running pid=3229655 socket=/run/user/1000/vela/agent.sock
DAEMON_RESTART_LIVE_RUN_OK run_id=daemon-restart-54eea00f752646c2bbaac5f76e3ef828 port=56703 url=http://127.0.0.1:56703 returncode=0
== Disconnect/reconnect stream resume ==
DISCONNECT_RECONNECT_RESUME_OK run_id=disconnect-reconnect-331256447e7a420aa6d237ee003b8ada first_seq=1 resume_inode=17956919 resume_offset=34 url=http://127.0.0.1:41537 returncode=0
cwd=/home/bgconley/repos/lab-tui
...
READY http://10.25.0.51:18003 models=qwen36-27b-fp8-kvfp8-rp6000 run_id=559969b231204a1dab046f612a051183
VELA_SMOKE_RUN_ID	559969b231204a1dab046f612a051183
BACKEND_EVIDENCE_OK config=qwen36-27b-fp8-kvfp8-rp6000-blackbird run_id=559969b231204a1dab046f612a051183
```

## Result

- Completed: `2026-06-07T07:53:39Z`
- Exit status: `0`
