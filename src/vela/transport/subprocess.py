...
from vela.agent.local import PROTOCOL_VERSION, TargetCallError
from vela.transport.client import (
    agent_error_event,
...
from vela.transport.rpc_errors import target_call_error_from_rpc_payload
...
def _agent_process_exit_error(
    ...
    *,
    ...
    if exit_code == 127 or missing_command is not None:
        command = missing_command or "vela"
